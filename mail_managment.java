...
public static void mail_remind(String to, String name ) {    
    // Recipient's email ID needs to be mentioned.
	  String from = "19bublyk99@gmail.com";
	  String fromPass = "andriy69";
    String text = "Шановний" + name + ", з часу Вашого останнього візиту пройшло півроку,ми наполегливо радимо Вам відвідати стоматолога найближчим часом";
